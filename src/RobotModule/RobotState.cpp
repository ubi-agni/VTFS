...
//    JntPosition_mea.setZero(7);
    ...
    linear_filter = new TemporalSmoothingFilter<Eigen::Vector3d>(50,Average,Eigen::Vector3d(0,0,0));
    angle_filter = new TemporalSmoothingFilter<Eigen::Vector3d>(50,Average,Eigen::Vector3d(0,0,0));
}
