...
/*
 ...
 Description : kuka tactile servoing object surface test
 ============================================================================
 */
...
void exploring(){
    static FPSLimiter fpsl(0.2);
    fpsl.wait();
    if(StartExploring == true) {
        mutex_act.lock();
        ac_vec.clear();
        task_vec.clear();
...
//            std::cout<<"positive dir........................................................................................................................................"<<std::endl;
        }else{
            taskname.prot = RLYN;
            ac_vec.push_back(new ProActController(*pm));
            ac_vec.back()->set_init_TM(kuka_left_arm->get_cur_cart_o());
...
//    std::cout<<"contact information "<<left_myrmex_msg.cf<<","<<left_myrmex_msg.cogx<<","<<left_myrmex_msg.cogy<<","<<left_myrmex_msg.contactflag<<std::endl;
    ...
    std::cout<<"no error until here"<<std::endl;
...
{
    return ICLApp(argc,argv,"-input|-i(2)",init,run,tactileviarsb,exploring).exec();
}
